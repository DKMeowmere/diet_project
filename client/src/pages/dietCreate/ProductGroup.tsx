...
export default function ProductGroup({ meal, day, productGroup }: Props) {
	...
	function deleteProductGroup() {
		...
		dispatch(removeProductGroup({ dayId: day._id, mealId: meal._id, productGroup }))
	}
	...
	return (
		<ProductGroupContainer>
			...
			<div className='product-container'>
				...
				<div className='fiber-meal'>{getMealProductGroupProperty('fiber', meal, productGroup._id)} Bł</div>
